...
<form action="login.php" method="post" name="form1">
  ...
  <div align="center"><img src="give_blood_give_life.jpg" width="1108" height="233" />
  </div>
</form>
<form action="check1.php" method="post" name="form2">
  <table width="676" height="446" border="0" align="center">
    <tr>
      <td height="35" colspan="2"><div align="center"><strong>Registration Form </strong></div></td>
    </tr>
    <tr>
      <td width="187" height="35" bgcolor="#cccccc">Name</td>
      <td width="473" bgcolor="#cccccc"><label>
    ...
    <tr>
      <td height="35" bgcolor="#cccccc">Username</td>
    ...
    <tr>
      <td height="35" bgcolor="#cccccc">Mobile</td>
      <td bgcolor="#cccccc"><label>
        <input name="mobile" type="text" size="10" />
      </label></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="35" bgcolor="#cccccc">Address</td>
      <td bgcolor="#cccccc"><label>
        <input name="address" type="text" size="65" />
      </label></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="35" bgcolor="#cccccc">Country</td>
      <td bgcolor="#cccccc">INDIA</td>
    </tr>
    <tr>
      <td height="35" colspan="2"><label> </label>
          <div align="center">
  ...
  <form action="search.php" method="post" name="form3"> 
  <table width="267" height="182" border="0">
    <tr>
      <td width="129"><p>Search For Blood</p>
          <p>
            <label>
            <select name="select">
              <option>-Select one-</option>
      ...
      <td width="128"><img src="bloodie.jpg" alt="Donate It" width="107" height="156" /></td>
    </tr>
  </table>
</form>
</body>
